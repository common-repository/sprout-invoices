...
class SI_l10n extends SI_Controller {
	...
	public static function language_detector_admin_notices() {
		...
		printf(
			...
			sprintf(
				'<span class="dashicons dashicons-megaphone"></span><b>%1$s</b>%6$s<b>%2$s</b>%7$s<a href="%3$s" target="_blank">%3$s</a>%8$s<a href="%4$s" target="_blank">%9$s</a>%10$s<a href="%5$s" target="_blank">%11$s</a>.',
				...
				esc_url( si_get_sa_link( 'https://sproutinvoices.com/sprout-invoices/purchase/', 'translation' ) ),
				esc_url( si_get_sa_link( 'https://sproutinvoices.com/marketplace/', 'translation' ) ),
				esc_html__( ' does not have a translation for ', 'sprout-invoices' ),
				esc_html__( ', please help the community translate at ', 'sprout-invoices' ),
				esc_html__( '. Supporting translators receive major discounts on ', 'sprout-invoices' ),
				esc_html__( 'pro licenses', 'sprout-invoices' ),
				esc_html__( ' and ', 'sprout-invoices' ),
				esc_html__( 'add-ons', 'sprout-invoices' )
			)
		);
	}
