 ...
 */
	function si_company_email() {
		echo esc_html( apply_filters( 'si_company_email', si_get_company_email() ) );
	}
endif;
 ...
 */
	function si_company_name() {
		echo esc_html( apply_filters( 'si_company_name', si_get_company_name() ) );
	}
endif;
 ...
 */
	function si_company_phone() {
		echo esc_html( apply_filters( 'si_company_phone', si_get_company_phone() ) );
	}
endif;
 ...
 */
	function si_company_fax() {
		echo esc_html( apply_filters( 'si_company_fax', si_get_company_fax() ) );
	}
endif;
