...
if ( ! function_exists( 'si_estimate_status' ) ) :
	...
	function si_estimate_status( $id = 0 ) {
		...
		echo esc_attr( apply_filters( 'si_estimate_status', si_get_estimate_status( $id ), $id ) );
	}
endif;
...
if ( ! function_exists( 'si_estimate_status_label' ) ) :
	...
	function si_estimate_status_label( $id = 0 ) {
		...
		echo esc_html( apply_filters( 'si_estimate_status_label', si_get_estimate_status_label( $id ), $id ) );
	}
endif;
...
if ( ! function_exists( 'si_estimate_issue_date' ) ) :
	...
	function si_estimate_issue_date( $id = 0 ) {
		...
		echo esc_html( apply_filters( 'si_estimate_issue_date', date_i18n( get_option( 'date_format' ), si_get_estimate_issue_date( $id ) ), $id ) );
	}
endif;
...
if ( ! function_exists( 'si_estimate_expiration_date' ) ) :
	...
	function si_estimate_expiration_date( $id = 0 ) {
		...
		echo esc_html( apply_filters( 'si_estimate_expiration_date', date_i18n( get_option( 'date_format' ), si_get_estimate_expiration_date( $id ) ), $id ) );
	}
endif;
...
if ( ! function_exists( 'si_estimate_id' ) ) :
	...
	function si_estimate_id( $id = 0 ) {
		...
		echo esc_html( apply_filters( 'si_estimate_id', si_get_estimate_id( $id ), $id ) );
	}
endif;
...
if ( ! function_exists( 'si_estimate_po_number' ) ) :
	...
	function si_estimate_po_number( $id = 0 ) {
		...
		echo esc_html( apply_filters( 'si_estimate_po_number', si_get_estimate_po_number( $id ), $id ) );
	}
endif;
...
if ( ! function_exists( 'si_estimate_client_id' ) ) :
	...
	function si_estimate_client_id( $id = 0 ) {
		...
		echo esc_html( apply_filters( 'si_estimate_client_id', si_get_estimate_client_id( $id ), $id ) );
	}
endif;
...
if ( ! function_exists( 'si_estimate_invoice_id' ) ) :
	...
	function si_estimate_invoice_id( $id = 0 ) {
		...
		echo esc_html( apply_filters( 'si_estimate_invoice_id', si_get_estimate_invoice_id( $id ), $id ) );
	}
endif;
...
if ( ! function_exists( 'si_estimate_discount' ) ) :
	...
	function si_estimate_discount( $id = 0 ) {
		...
		echo esc_html( apply_filters( 'si_estimate_discount', si_get_estimate_discount( $id ), $id ) );
	}
endif;
...
if ( ! function_exists( 'si_estimate_tax' ) ) :
	...
	function si_estimate_tax( $id = 0 ) {
		...
		echo esc_html( apply_filters( 'si_estimate_tax', si_get_estimate_tax( $id ), $id ) );
	}
endif;
...
if ( ! function_exists( 'si_estimate_tax2' ) ) :
	...
	function si_estimate_tax2( $id = 0 ) {
		...
		echo esc_html( apply_filters( 'si_estimate_tax2', si_get_estimate_tax2( $id ), $id ) );
	}
endif;
...
if ( ! function_exists( 'si_estimate_total' ) ) :
	...
	function si_estimate_total( $id = 0 ) {
		...
		echo esc_html( apply_filters( 'si_estimate_total', sa_get_formatted_money( si_get_estimate_total( $id ), $id ), $id ) );
	}
endif;
...
if ( ! function_exists( 'si_estimate_subtotal' ) ) :
	...
	function si_estimate_subtotal( $id = 0 ) {
		...
		echo esc_html( apply_filters( 'si_estimate_subtotal', sa_get_formatted_money( si_get_estimate_subtotal( $id ), $id ), $id ) );
	}
endif;
...
if ( ! function_exists( 'si_estimate_sender_note' ) ) :
	...
	function si_estimate_sender_note( $id = 0 ) {
		...
		echo esc_html( apply_filters( 'si_estimate_sender_note', si_get_estimate_sender_note( $id ), $id ) );
	}
endif;
...
if ( ! function_exists( 'si_estimate_currency' ) ) :
	...
	function si_estimate_currency( $id = 0 ) {
		...
		echo esc_html( apply_filters( 'si_estimate_currency', si_get_estimate_currency( $id ), $id ) );
	}
endif;
