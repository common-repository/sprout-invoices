	...
	<div class="main">
		...
		<script type="text/javascript" charset="utf-8">
				...
				jQuery.post( ajaxurl, { 
					...
					function( response ) {
						...
						req_est_totals_data = {
							...
							datasets: [
								{
									label: "<?php esc_html_e( 'Requests', 'sprout-invoices' ) ?>",
								...
								{
									label: "<?php esc_html_e( 'Invoices Generated', 'sprout-invoices' ) ?>",
			...
			jQuery(document).ready(function($) {
				...
				req_est_totals_button.on( 'click', function( e ) {
					// load chart
					req_est_chart_data();
				} );
			});
		</script>
		<p class="description"><?php esc_html_e( 'Shows total estimate requests and the total converted into invoices.', 'sprout-invoices' ) ?></p>
	</div>
</div>