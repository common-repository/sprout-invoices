...
if ( 0 != $post->ID ) {
	...
	$stamp = __( 'immediately', 'sprout-invoices' );
...
<div class="misc-pub-section" data-edit-id="due_date" data-edit-type="date">
	...
	<div id="due_date_div" class="control_wrap hide-if-js">
		...
		<p>
			...
			<a href="#edit_due_date" class="cancel_control cancel-due_date hide-if-no-js button-cancel"><?php esc_html_e( 'Cancel', 'sprout-invoices' ) ?></a>
		</p>
 	</div>
</div>
...
<div class="misc-pub-section" data-edit-id="client" data-edit-type="select">
	...
	?>
	<span id="client" class="wp-media-buttons-icon"><?php esc_html_e( 'Invoice for', 'sprout-invoices' ) ?> <b><?php echo wp_kses( $client_name, $wp_kses_client_name ) ?></b></span>
...
<?php if ( $estimate_id ) :  ?>
	...
	<div class="misc-pub-section" data-edit-id="estimate_id">
		<span id="estimate_id" class="wp-media-buttons-icon"><?php esc_html_e( 'Associated Estimate:', 'sprout-invoices' ) ?> <b><a href="<?php echo esc_url( get_edit_post_link( $estimate_id ) ) ?>"><?php echo esc_html( get_the_title( $estimate_id ) ) ?></a></b></span>
	</div>
<?php endif ?>
...
<div class="misc-pub-section" data-edit-id="invoice_id">
	<span id="invoice_id" class="wp-media-buttons-icon"><?php esc_html_e( 'Invoice ID', 'sprout-invoices' ) ?> #<b><?php echo esc_html( $invoice_id ); ?></b></span>

	<a href="#edit_invoice_id" class="edit-invoice_id hide-if-no-js edit_control">
		<span aria-hidden="true"><?php esc_html_e( 'Edit', 'sprout-invoices' ) ?></span> <span class="screen-reader-text"><?php esc_html_e( 'Edit invoice id', 'sprout-invoices' ) ?></span>
	</a>
	...
	<div id="invoice_id_div" class="control_wrap hide-if-js">
		...
		<p>
			<a href="#edit_invoice_id" class="save_control save-invoice_id button"><?php esc_html_e( 'OK', 'sprout-invoices' ) ?></a>
			<a href="#edit_invoice_id" class="cancel_control cancel-invoice_id button-cancel"><?php esc_html_e( 'Cancel', 'sprout-invoices' ) ?></a>
		</p>
 	</div>
</div>
...
<div class="misc-pub-section update-total" data-edit-id="discount">
	...
	<a href="#edit_discount" class="edit-discount hide-if-no-js edit_control" >
 	...
 	<span title="<?php esc_html_e( 'The discount is applied after tax.', 'sprout-invoices' ) ?>" class="helptip"></span>
...
<div class="misc-pub-section update-total" data-edit-id="tax">
	...
	<span title="<?php esc_html_e( 'Tax is applied before the discount.', 'sprout-invoices' ) ?>" class="helptip"></span>
