...
<div id="admin_payments_options_wrap" class="admin_fields clearfix">
	...
	<div id="admin_payments_option" class="form-group">
		...
		<div class="input_wrap">
			<a href="javascript:void(0)" class="button" id="add_admin_payments"><?php esc_html_e( 'Quick Add', 'sprout-invoices' ) ?></a> <span class="helptip" title="<?php esc_html_e( 'Add the payment now or save/update the invoice above', 'sprout-invoices' ) ?>"></span>
		</div>
	</div>
</div>
