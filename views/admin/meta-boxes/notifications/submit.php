	...
	<div id="minor-publishing">
		...
		<p>
			<span id="notification_type_disabled_wrap">
				<input type="checkbox" id="notification_type_disabled" name="notification_type_disabled" value="TRUE" <?php checked( 'TRUE', $disabled ) ?> />&nbsp;<?php esc_html_e( 'Disabled', 'sprout-invoices' ) ?>
			</span>
		</p>
