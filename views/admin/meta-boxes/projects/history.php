	...
	<p>
		...
		<?php
			if ( apply_filters( 'show_upgrade_messaging', true ) ) {
				sprintf(
					// translators: 1:opening span tag, 2:opening a tag with href, 3:Pro Upgrade link, 4: end of href, 5:closing a tag, 6:closing span tag
					esc_html__( '%1$sUpgrade for Private Notes%2$s%3$s%4$s%5$sUpgrade to Pro to add private notes.%6$s%7$s', 'sprout-invoices' ),
