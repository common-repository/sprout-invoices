<div id="test_send_selection">
	...
	<p class="description help_block"><?php esc_html_e( 'Select a type of notification to send a test.', 'sprout-invoices' ) ?></p>
	...
	<?php else : ?>
		<p><?php esc_html_e( 'Create an invoice and come back to run a test send.', 'sprout-invoices' ) ?></p>
	<?php endif ?>
	...
	<?php else : ?>
		<p><?php esc_html_e( 'Create an estimate and come back to run a test send.', 'sprout-invoices' ) ?></p>
	<?php endif ?>
	...
	<?php else : ?>
		<p><?php esc_html_e( 'Create a client and come back to run a test send.', 'sprout-invoices' ) ?></p>
	<?php endif ?>
	...
	<?php else : ?>
		<p><?php esc_html_e( 'Create a payment and come back to run a test send.', 'sprout-invoices' ) ?></p>
	<?php endif ?>

	<span class="button" id="send_test_notification" style="display:none;"><?php esc_html_e( 'Send', 'sprout-invoices' ) ?></span>
