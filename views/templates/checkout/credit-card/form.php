<div id="credit_card_checkout_wrap">
	...
	<form action="<?php echo esc_attr( si_get_credit_card_checkout_form_action() )?>" method="post" accept-charset="utf-8" class="sa-form sa-form-aligned" id="si_credit_card_form">
		...
		<div id="billing_cc_fields" class="clearfix">
			<fieldset id="billing_fields" class="sa-fieldset">
				<legend><?php esc_html_e( 'Billing', 'sprout-invoices' ) ?></legend>
			...
			<fieldset id="credit_card_fields" class="sa-fieldset">
				<legend><?php esc_html_e( 'Credit Card', 'sprout-invoices' ) ?></legend>
			...
			<button type="submit" class="button button-primary" id="credit_card_submit"><?php esc_html_e( 'Submit', 'sprout-invoices' ) ?></button>
