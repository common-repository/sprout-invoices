							...
							<dl id="doc_address_info">
								...
								<?php if ( si_get_estimate_client_id() ) : ?>
									<dl class="client_addy">
										...
										<dd>
											<b><?php echo esc_html( get_the_title( si_get_estimate_client_id() ) ); ?>
					...
					<aside>
						<ul class="doc_footer_items">
							<li class="doc_footer_item">
								<?php printf( '<strong>%s</strong> %s', '<div class="dashicons dashicons-admin-site"></div>', wp_kses( make_clickable( home_url() ), kses_si_front_end_line_item() ) ); ?>
							</li>
							<?php if ( si_get_company_email() ) : ?>
								<li class="doc_footer_item">
									<?php printf( '<strong><div class="dashicons dashicons-email-alt"></div></strong> %s', wp_kses( make_clickable( si_get_company_email() ), kses_si_front_end_line_item() ) ); ?>
								</li>
							<?php endif ?>
						</ul>
					</aside>
