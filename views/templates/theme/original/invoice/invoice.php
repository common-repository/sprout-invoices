				...
				<header id="header_title">
					...
					<span class="header_id">
						<?php
							...
							esc_html__( 'Invoice %s', 'sprout-invoices' ),
						...
						<ul class="doc_footer_items">
							<li class="doc_footer_item">
								<?php
									...
									'<strong>',
									'<div class="dashicons dashicons-admin-site"></div>',
									'</strong>',
									wp_kses( make_clickable( home_url() ), SI_Settings_API::get_allowed_html() )
									)
								?>
							</li>
							<?php if ( si_get_company_email() ) : ?>
								<li class="doc_footer_item">
									<?php
										...
										'<div class="dashicons dashicons-admin-site"></div>',
										'</strong>',
										wp_kses( make_clickable( si_get_company_email() ), SI_Settings_API::get_allowed_html() )
										)
									?>
								</li>
							<?php endif ?>
