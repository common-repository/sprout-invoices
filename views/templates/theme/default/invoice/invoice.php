			...
			<div class="inner">
				...
				<div class="row intro">
					...
					<span>
						<?php
							printf(
							// translators: 1: invoice id
							esc_html__( 'Invoice %1$s', 'sprout-invoices' ),
				...
				<div class="row history_message">
					<?php if ( si_doc_last_updated() === $last_updated ) : ?>
			...
			<section class="row" id="paybar">
				<div class="inner">
					...
					<?php if ( 'complete' === si_get_invoice_status() ) : ?>
						<?php printf( 'Total of <strong>%1$s</strong> has been <strong>Paid</strong>', esc_html( sa_get_formatted_money( si_get_invoice_total() ) ) ); ?>
					<?php else : ?>
						<?php printf( 'Total of <strong>%1$s</strong> has been <strong>Reconciled</strong>', esc_html( sa_get_formatted_money( si_get_invoice_total() ) ) ); ?>
					<?php endif ?>
