<div id="popayment_info_checkout_wrap" class="paytype inactive">
	<form action="<?php echo esc_attr( si_get_payment_link( get_the_ID(), $type ) ) ?>" method="post" accept-charset="utf-8" class="sa-form sa-form-aligned" enctype="multipart/form-data">
		<div class="row">
		...
		<button type="submit" class="button"><?php esc_html_e( 'Submit PO Info', 'sprout-invoices' ) ?></button>
	</form>
