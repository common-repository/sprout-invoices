	...
	<span class="input_wrap">
		<span class="sa-form-field sa-form-field-radios sa-form-field-required">
				...
				<?php foreach ( $cards as $payment_profile_id => $name ) : ?>
					<span class="sa-form-field-radio clearfix">
						<label for="sa_credit_payment_method_<?php echo esc_attr( $payment_profile_id ) ?>">
							...
							<?php 
								printf( '%2$s <a href="javascript:void(0)" data-ref="%3$s" data-invoice-id="%5$s" class="cim_delete_card" title="%4$s">%6$s</a>',
			...
			<span class="sa-form-field-radio clearfix">
				...
				<input type="radio" name="sa_credit_payment_method" id="sa_credit_payment_method_credit" value="new_credit" checked="checked"><b><?php esc_html_e( 'New Credit/Debit Card' , 'sprout-invoices' ) ?></b></label>
			</span>
		</span>
	</span>
