...
function sprout_invoices_load() {
	...
	// System Health
	if ( file_exists( SI_PATH . '/controllers/admin/system-health.php' ) ) {
		require_once SI_PATH . '/controllers/admin/system-health.php';
	}
	// Estimates
	...
	// System Health Check Init.
	if ( class_exists( 'SI_System_Health' ) ) {
		SI_System_Health::init();
	}
	...
	// Wizard.
	if ( ! class_exists( 'SI_Admin_Setup_Wizard' ) ) {
		require_once SI_PATH . '/controllers/getting-started-wizard/si-admin-setup-wizard.php';
	}
