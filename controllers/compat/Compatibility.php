...
class SI_Compatibility extends SI_Controller {
	...
	public static function init() {
		...
		// WP SEO
		add_filter( 'init', array( __CLASS__, 'prevent_wpseo_from_blocking_admin_columns' ), 10000 );
		add_filter( 'add_meta_boxes', array( __CLASS__, 'prevent_wpseo_from_blocking_private_cpts_metaboxes' ), 10 );
	...
	public static function prevent_wpseo_from_blocking_admin_columns() {
		if ( self::is_si_admin() ) {
	...
	public static function prevent_wpseo_from_blocking_private_cpts_metaboxes() {
		if ( self::is_si_admin() ) {
