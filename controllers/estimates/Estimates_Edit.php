...
class SI_Estimates_Edit extends SI_Estimates {
	...
	public static function save_meta_box_estimate_information( $post_id, $post, $callback_args, $estimate_id = null ) {
		...
		$expiration_m = ( isset( $_POST['expiration_mm'] ) && $_POST['expiration_mm'] != '' ) ? sanitize_text_field( wp_unslash( $_POST['expiration_mm'] ) ) : '' ;
		$expiration_j = ( isset( $_POST['expiration_j'] ) && $_POST['expiration_j'] != '' ) ? sanitize_text_field( wp_unslash( $_POST['expiration_j'] ) ) : '' ;
		$expiration_o = ( isset( $_POST['expiration_o'] ) && $_POST['expiration_o'] != '' ) ? sanitize_text_field( wp_unslash( $_POST['expiration_o'] ) ) : '' ;
		$estimate_id  = ( isset( $_POST['estimate_id'] ) && $_POST['estimate_id'] != '' ) ? sanitize_text_field( wp_unslash( $_POST['estimate_id'] ) ) : '' ;
		$po_number    = ( isset( $_POST['po_number'] ) && $_POST['po_number'] != '' ) ? sanitize_text_field( wp_unslash( $_POST['po_number'] ) ) : '' ;
		$client_id    = ( isset( $_POST['sa_metabox_client'] ) && $_POST['sa_metabox_client'] != '' ) ? sanitize_text_field( wp_unslash( $_POST['sa_metabox_client'] ) ) : '' ;
		$discount     = ( isset( $_POST['discount'] ) && $_POST['discount'] != '' ) ? sanitize_text_field( wp_unslash( $_POST['discount'] ) ) : '' ;
		$tax          = ( isset( $_POST['tax'] ) && $_POST['tax'] != '' ) ? sanitize_text_field( wp_unslash( $_POST['tax'] ) ) : '' ;
		$tax2         = ( isset( $_POST['tax2'] ) && $_POST['tax2'] != '' ) ? sanitize_text_field( wp_unslash( $_POST['tax2'] ) ) : '' ;
		$currency     = ( isset( $_POST['currency'] ) && $_POST['currency'] != '' ) ? sanitize_text_field( wp_unslash( $_POST['currency'] ) ) : '' ;
	...
	public static function show_estimate_send_view( $post, $metabox ) {
		if ( $post->post_status == 'auto-draft' ) {
			printf( '<p>%s</p>', esc_html__( 'Save this estimate before sending.', 'sprout-invoices' ) );
			return;
		}
		$estimate = SI_Estimate::get_instance( $post->ID );
	...
	public static function save_estimate_note( $post_id, $post, $callback_args, $estimate_id = null ) {
		...
		$recipients = ( isset( $_REQUEST['sa_metabox_recipients'] ) ) ? sanitize_text_field( wp_unslash( $_REQUEST['sa_metabox_recipients'] ) ) : array();
	...
	public static function save_notes( $post_id, $post, $callback_args, $estimate_id = null ) {
		...
		$estimate_notes = ( isset( $_POST['estimate_notes'] ) && $_POST['estimate_notes'] != '' ) ? wp_kses_post( wp_unslash( $_POST['estimate_notes'] ) ) : '' ;
