...
class SI_Freshbooks_Import extends SI_Importer {
	...
	public static function save_options() {
		...
		if ( isset( $_POST[ self::FRESHBOOKS_ACCOUNT_OPTION ] ) && $_POST[ self::FRESHBOOKS_ACCOUNT_OPTION ] != '' ) {
			self::$freshbooks_account = sanitize_text_field( wp_unslash( $_POST[ self::FRESHBOOKS_ACCOUNT_OPTION ] ) );
			update_option( self::FRESHBOOKS_ACCOUNT_OPTION, self::$freshbooks_account );
		}
