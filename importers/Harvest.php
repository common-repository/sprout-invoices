...
class SI_Harvest_Import extends SI_Importer {
	...
	public static function save_options() {
		...
		if ( isset( $_POST[ self::HARVEST_PASS_OPTION ] ) && $_POST[ self::HARVEST_PASS_OPTION ] != '' ) {
			self::$harvest_pass = sanitize_text_field( wp_unslash( $_POST[ self::HARVEST_PASS_OPTION ] ) );
			update_option( self::HARVEST_PASS_OPTION, self::$harvest_pass );
		}
		if ( isset( $_POST[ self::HARVEST_ACCOUNT_OPTION ] ) && $_POST[ self::HARVEST_ACCOUNT_OPTION ] != '' ) {
			self::$harvest_account = sanitize_text_field( wp_unslash( $_POST[ self::HARVEST_ACCOUNT_OPTION ] ) );
			update_option( self::HARVEST_ACCOUNT_OPTION, self::$harvest_account  );
